...
<body>
    <div class="container">
        <header>
            ...
            <div class="header-buttons">
                <button href="index.php">Entrar</button>
  ...
  <main>
    ...
    <div class="produtos">
      <?php
        $produtos = [
          ["nome" => "batom max love", "preco" => 49.90, "imagem" => "https://ecoms1-nyc3.nyc3.cdn.digitaloceanspaces.com/51331/@v3/1675618861952-batommaxloveliquido30horascor606ate6111.jpg"],
